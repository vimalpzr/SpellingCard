...
public class Animal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] a_text = {"Lion", "tiger", "hourse","fox"};
        int[] a_id = {R.drawable.lion, R.drawable.tiger, R.drawable.hourse, R.drawable.fox};
...
//            description.setText(String.valueOf(itemList.get(listPosition)));
           ...
           TextView tvcato = (TextView)convertView. findViewById(R.id.tvcat);
            tvcato.setText(scat);
            ...
            if (listPosition==0){
                ...
                try {
                    ...
                    Toast.makeText(Animal.this, "ghhf", Toast.LENGTH_SHORT).show();
                }
...
//                Toast.makeText(LearnEachAlphabet.this, String.valueOf(listPosition), Toast.LENGTH_SHORT).show();
                        ...
                        tts = new TextToSpeech(Animal.this, new TextToSpeech.OnInitListener() {
                                        ...
                                        final Handler handler = new Handler() {
                                            ...
                                            public void handleMessage(Message msg) {
                                                try {
                                                    ...
                                                    // Toast.makeText(Animal.this, "fgh", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        };
